	    	...
	    	<div class=" col-md-6 col-md-offset-3 ">
	    		...
	    		<div class="panel panel-default ">
					  ...
					  <div class="form-group has-feedback">
					    <label for="usuario" class=" control-label">User: <?=$_SESSION['usuario']?></label>				    
					    <input type="hidden" class="form-control " id="usuario" name="usuario" value=<?="'".$_SESSION['usuario']."'" ?> >
					    
					    <div id="resusu"></div>					    
					  </div>
					  <div class="form-group has-feedback">
					    <label for="Pass" class=" control-label">Actual Password</label>				    
					  ...
					  <div class="form-group has-feedback">
					    ...
					    <input type="Password" class="form-control" id="Password1" name= "contrasena1" placeholder="New Password" required>					
