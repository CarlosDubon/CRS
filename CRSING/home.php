		...
		<?php
			...
			if (isset($_SESSION['idcliente'])) {
				$cliente=null;
				    ...
				    echo "<center><FONT SIZE=5 COLOR=yellow><h2>WELCOME! SUCCESSFULLY <br>LOG IN: </h2><h3>".$_SESSION['usuario']."</h3> <br> YOUR CURRENT BALANCE IS: $ ".$cliente['saldo']."</FONT></center>";
				...
				echo "<FONT ALIGN=center SIZE=5 COLOR=yellow><h2>WELCOME! SUCCESSFULLY <br>LOG IN: </h2><h3>".$_SESSION['usuario']."</h3> <br></FONT>";
			    ...
			    <div class="row">
			    	<div class="col-md-6 col-md-offset-3">
			    		...
			    		<div class="alert alert-danger">
					     <strong>Alert!</strong> The Username or Password are incorrect
					    </div>
