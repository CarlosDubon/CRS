	...
	<div class="container-fluid col-md-6 col-md-offset-3">
		<div class="panel panel-default">
			<div class="panel-heading">
					<h3 class="panel-title"><b><span class="glyphicon glyphicon-list-alt"></span> Show Users</b></h3>
			</div>
			  	...
			  	<table class="table table-hover">
			  			<thead>
							<tr>
								...
								<th><span class="glyphicon glyphicon-question-sign"></span> Type</th> 
								<th><span class="glyphicon glyphicon-envelope"></span> E-Mail</th>
								<th><span class="glyphicon glyphicon-refresh"></span> Update</th>
								<th><span class="glyphicon glyphicon-trash"></span> Delete</th>
								<th><span class="glyphicon glyphicon-usd"></span> Balance</th>
							</tr>
						</thead>
						<tbody>
<?php
					    ...
					    try {
					        ...
					        foreach ($result as $row) {
					            ?>
					            			<tr>
												<td><?=$row ["usuario"]?></td><td><?=$row ["tipo"]==1?"Administrator":"Client"?></td>
												<td><?=$row ["correo"]?></td>
												<td><a <?="href='modificarUsuario.php?usuario=".$row ["usuario"]."'"?>>Update</a></td>
												<td><a <?="href='mostrarUsuario.php?usuario=".$row ["usuario"]."'"?> onclick="return confirm('Are you sure?');">Delete</a></td>
												<td><a <?="href='agregarsaldo.php?usuario=".$row ["usuario"]."'"?>>Add Balance</a></td>
											</tr>
					        <?php
                            }
					        /*** close the database connection ***/
