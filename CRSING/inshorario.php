	...
	if (isset($_POST['fecha'])) {
	    ...
	    try {
	        ...
	        $mensaje="<div class='alert alert-success'>
			      <strong>Success! </strong>Schedule inserted successfully 
			    </div>";
	    }
	...
	<div class="container-fluid">
		<div class="panel panel-default col-md-6 col-md-offset-3">
			  <div class="panel-heading">
					<h3 class="panel-title"><b>New Schedule</b></h3>
			  </div>
			  <div class="panel-body">
			  	<?=$mensaje?>
					<form action="inshorario.php" method="POST" role="form">
						...
						<button type="submit" id="enviar" disabled class="btn btn-warning">Submit</button>
					</form>
			  </div>
		</div>
	...
	<footer>
		...
		<script type="text/javascript">
		 //$(document).ready(function() {
			//$('#hinicio').clockpicker();
			$('#fecha').datetimepicker({value: hoy() , minDate:0,lang:'en',format:'m-d-Y',timepicker:false, mask:true});
